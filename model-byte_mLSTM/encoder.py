...
import importlib
utils = importlib.import_module('model-byte_mLSTM.utils')
HParams, preprocess, iter_data = utils.HParams, utils.preprocess, utils.iter_data


# NOTE: Set necessary paths here
MODELDIR = '/n/fs/nlpdatasets/SentimentNeuron/model/'
...
class Model(object):
    ...
    def __init__(self, nbatch=128, nsteps=64):
        ...
        global params
        params = [np.load(MODELDIR+'%d.npy'%i) for i in range(15)]
